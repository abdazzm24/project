...
@section('title', 'Regis Pet')

@section('content')
<div class="form-page">
    <div class="form-card">
        <h2 class="form-title">Registrasi Pet</h2>

        <form action="{{ route('resepsionis.regispet.store') }}" method="POST">
            @csrf
            ...
            <div class="form-buttons">
                <a href="{{ route('resepsionis.regispet.index') }}" class="btn-secondary">Kembali</a>
